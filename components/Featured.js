...
const Featured = () => {
  return (
    <>
      ...
      <ScrollView showsHorizontalScrollIndicator={false} horizontal style={{ paddingHorizontal: 15, marginTop: 20 }}>
      ...
      <View style={styles.titleContainer}>
        ...
        <Text style={styles.subTitle}>Icecreams offers a wide variety of high-quality, delicious flavors, perfect for any occasion</Text>
      </View>
      <ScrollView showsHorizontalScrollIndicator={false} horizontal style={{ paddingHorizontal: 15, marginTop: 20 }}>
